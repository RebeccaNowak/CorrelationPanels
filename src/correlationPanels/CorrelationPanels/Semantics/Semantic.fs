...
module Semantic = 
  ...
  module Lens = 
    let _color     : Lens<Semantic,C4b>    = Semantic.Lens.style |. Style.Lens.color |. ColorInput.Lens.c
    let _thickness : Lens<Semantic,float>  = Semantic.Lens.style |. Style.Lens.thickness |. NumericInput.Lens.value
    let _labelText : Lens<Semantic,string> = Semantic.Lens.label |. TextInput.Lens.text
